...
export default function AboutUsPage() {
  return (
    <div className="flex w-full flex-col gap-16 ">
      <ImageWithOverlay
        imageUrl="/images/david_podcast.jpg"
        className="my-26 h-[750px] w-full"
      >
      ...
      <CtaSection
        title="Investujte do růstu"
        subtitle="Naším cílem je posílit vás k soběstačnosti a akcelerovat váš růst. Domluvte si nezávaznou konzultaci a
