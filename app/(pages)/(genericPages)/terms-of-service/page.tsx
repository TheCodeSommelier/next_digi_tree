...
const sections = [
  {
    ...
    body: [
      `Tyto obchodní podmínky (dále jen „Podmínky“) stanovují podmínky a pravidla užívání vzdělávacích služeb poskytovaných společností DigiTree Education, s.r.o., IČ: ${contacts.ico}, se sídlem ${contacts.address} (dále jen „Poskytovatel“), a upravují práva a povinnosti mezi Poskytovatelem a uživateli těchto služeb (dále jen „Zákazník“).`,
  ...
  },
  {
    ...
    body: [
      "Poskytovatel zpracovává osobní údaje Zákazníka v souladu s platnými právními předpisy, zejména GDPR.",
    ],
  },
  {
    ...
    <main className="flex w-full flex-col gap-8 py-26">
      <header className="space-y-2 py-4">
        <h1 className="text-4xl font-bold text-primary">
          Obchodní podmínky společnosti DigiTree Education, s.r.o.
        </h1>
        <p className="text-primary/80">
          Níže najdete souhrn pravidel a podmínek pro využívání našich
          vzdělávacích služeb. Čtěte prosím pozorně.
        </p>
      </header>
