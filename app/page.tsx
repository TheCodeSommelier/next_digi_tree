...
export const metadata = {
  title: "Domů | Digitree",
  description:
    "Digitree - Strategická AI a digitální transformace pro měřitelný růst vašeho podnikání. Pomáháme firmám automatizovat procesy, implementovat umělou inteligenci, navrhovat moderní software a zabezpečit data bez vendor lock-inu. Získejte strategický audit, akční plán a kontinuální optimalizaci pro výrazné zlepšení výkonu.",
};
          ...
          <section className="h-screen text-center flex flex-col items-center justify-between gap-6 py-26">
            <div className="flex flex-col h-full items-center justify-center gap-7">
              <h1 className="text-4xl md:text-7xl w-full lg:w-3/4 font-bold animate-fade-in-7">
                Digitree, měníme strategii v měřitelné výsledky
              </h1>
              <p className="flex flex-col w-full md:w-9/12 lg:w-7/12 text-lg animate-fade-in-8">
                Pomáháme firmám zlepšovat řízení, procesy a rozvoj lidí. Od
                procesního a manažerského poradenství přes firemní vzdělávání až
                po software, digitalizaci a praktické využití AI.
              </p>
