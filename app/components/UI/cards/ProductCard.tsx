    ...
    >
      ...
      <div className="relative flex h-full flex-col justify-between p-6">
        ...
        <div className="min-h-24 flex flex-col justify-end gap-2">
          <h3 className="text-2xl font-semibold text-white drop-shadow-sm translate-y-1
          transition-all duration-500 ease-out group-hover:-translate-y-1"
          >
            {title}
          </h3>
          <p className="max-w-xl text-sm leading-relaxed text-white/80 opacity-0
          translate-y-3 transition-all duration-500 ease-out group-hover:opacity-100 group-hover:translate-y-0"
          >
            {description}
          </p>
        </div>
