...
const ProudctCard: FC<Props> = ({ productId, title, icon, imageUrl }) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 bg-linear-to-b from-black/10
      ...
      <div className="relative flex h-full flex-col justify-between p-6">
        ...
        <div className="min-h-24 flex flex-col justify-end gap-2">
          <h3
            className="text-2xl font-semibold text-white drop-shadow-sm translate-y-1
