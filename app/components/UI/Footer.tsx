          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="flex flex-col gap-4 space-y-2">
              <Image
                ...
                alt="DigiTree company logo"
                width={width}
                height={100}
              />

              <p className="max-w-xl w-4/5 text-white text-sm md:text-base">
                Digitree je váš partner, pro rozvoj procesů managementu a lidí.
              </p>
            </div>
      ...
      <PagePadding>
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center text-gray-20 py-6 md:py-4 text-sm gap-4 md:gap-0">
          ...
          <p>
            Designed by{" "}
            <Link
              href="https://www.keyspace.cz"
              target="_blank"
              className="text-accent hover:text-white duration-200"
            >
              KeySpace
            </Link>
          </p>
