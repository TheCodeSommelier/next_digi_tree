      ...
      {isSent ? (
        <div className="text-primary flex flex-col items-center justify-center gap-6 animate-fade-in-8">
          ...
          <p className="text-center">
            ...
            Zatímco se věnujeme Vaší žádosti, projděte si naše{" "}
            <Link
              className="hover:text-accent border-b pb-px duration-200"
          ...
          >
            Chci poslat další email
          </Button>
        </div>
      ) : (
        <form
          onSubmit={handleSubmit}
          className="relative mt-6 space-y-4 animate-fade-in-8"
        >
          <TextInput
            id="nameInput"
            name="fullName"
